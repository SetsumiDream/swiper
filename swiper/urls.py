...
urlpatterns = [
    ...
    url(r'^api/social/like/recd/list/$', social_api.like),
    url(r'^api/social/dislike/recd/list/$', social_api.dislike),
    url(r'^api/social/superlike/recd/list/$', social_api.superlike),
